...
* **Создание и управление категориями бюджета** 
    ...
    – добавление доходов и расходов, установка лимитов с указанием категории.


* **Отображение информации по кошельку в виде отчетов в консоли** 

    – общая информация, отдельно доходы и расходы.
...
* **Сохранение данных и их загрузка при следующем запуске** 
    ...
    – с помощью сериализации/десериализации данных в users.dat.
